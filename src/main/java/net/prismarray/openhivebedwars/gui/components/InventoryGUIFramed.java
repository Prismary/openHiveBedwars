...
public class InventoryGUIFramed extends InventoryGUIBase {

    public InventoryGUIFramed(String name, int rows, DyeColor color, boolean hasCancel, @Nullable String previousGUI, @Nullable String nextGUI) {
